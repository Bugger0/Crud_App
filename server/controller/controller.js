...
.catch(err=>{
    res.status(500).send({message:err.message || "some eror occured while creating a create operation"
});
});
}

//retrieve and return all users/tetreve and return single user
